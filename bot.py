...
def create_retrieval_qa_bot():
    ...
    """
    vectorstore = Chroma(persist_directory=os.getenv('DB_PATH'), embedding_function=OllamaEmbeddings(model='llama3'))

    print('Here ',os.getenv('DB_PATH'))
...
async def start():
    ...
    await msg.send()
    msg.content = "Hi, welcome to Astrape Enterprise Chatbot. What is your query?"
    await msg.update()
...
async def process_chat_message(message):
    ...
    text_elements, _ = process_source_documents(source_documents)
